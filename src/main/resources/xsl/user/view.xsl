        ...
        <div class="card-body">
          <div class="row">
	                 ...
	                 <div class="dropdown-menu-header-inner bg-white">
	                     <div class="menu-header-content">
	                         ...
	                         <div class="menu-header-btn-pane pt-1">
                                 <a href="/user/admin/avatar/edit?id={item/id}" class="btn-shadow btn-wide btn-pill mr-1 btn-hover-shine btn btn-primary btn-icon btn btn-warning btn-sm"><xsl:text>Changer de photo</xsl:text></a>
                             </div>
	                     </div>
	                 </div>
	             </div>
              ...
              <div class="col-md-4">
                ...
                <p><xsl:value-of select="item/login"/></p>
              </div>
              <div class="col-md-4">
              	<h5><xsl:text>Profil</xsl:text></h5>
                <p><xsl:value-of select="item/profile"/></p>
              </div>
              <xsl:if test="item/blocked = 'true'">
              	  <div class="col-md-12">
	                <p><i>L'utilisateur est actuellement bloqué</i></p>
	              </div>
               </xsl:if>
            </div>
            <div class="divider"/>
