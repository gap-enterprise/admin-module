      ...
      <div class="card">
        ...
        <div class="card-header">
              <ul class="nav nav-justified">
                  <li class="nav-item">
                      <a data-toggle="tab" href="#tab-eg-0" class="nav-link active"><xsl:text>Informations générales </xsl:text></a>
                  </li>
                  <li class="nav-item">
                      <a data-toggle="tab" href="#tab-eg-1" class="nav-link"><xsl:text>Localisation </xsl:text></a>
                  </li>
                  <li class="nav-item">
                      <a data-toggle="tab" href="#tab-eg-2" class="nav-link"><xsl:text>Adresse et contacts </xsl:text></a>
                  </li>
                  <li class="nav-item">
                      <a data-toggle="tab" href="#tab-eg-3" class="nav-link"><xsl:text>Représentant </xsl:text></a>
                  </li>
                  <li class="nav-item">
                      <a data-toggle="tab" href="#tab-eg-4" class="nav-link"><xsl:text>Exportation de données </xsl:text></a>
                  </li>
 				  <li class="nav-item">
                      <a data-toggle="tab" href="#tab-eg-5" class="nav-link"><xsl:text>Type document de r&#xE9;f&#xE9;rence </xsl:text></a>
                  </li>
              </ul>
          </div>
